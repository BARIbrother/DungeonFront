...
Assets/Prefabs/Machines/제작기_tier1.prefab
Assets/Prefabs/Machines/창고_tier1.prefab
Assets/Prefabs/ResourceNodes/철광석_노드.prefab
```

- `machineDefId` = `채굴기_1` 형식과 티어 번호 규칙을 [03-machine-plan](../../planning/03-machine-plan.md)와 맞출 것
