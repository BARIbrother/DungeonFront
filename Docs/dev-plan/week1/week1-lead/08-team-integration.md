...
| 대상 | 전달물 |
|------|--------|
| **Dev** | `Factory` 씬 (Build Settings 등록됨), 맵 중앙 **스폰 월드 좌표**, Prefab 3종 경로 |
...
2. [ ] (Dev) **새 게임** → 플레이어 맵 **중앙**, 인벤 기계 3종 (HUD 확인)
3. [ ] **WASD** 이동
4. [ ] **생산 시작** → 타이머 **5:00** 표시
5. [ ] (디버그 또는 타이머 만료) **결산** 화면
6. [ ] **다음 날** → 일차 2, **Prepare**, Factory 복귀
7. [ ] (Art) 주인공 **walk** 모션 적용 시 이동 중 애니 재생
8. [ ] 기계 **10종+ v0.1** 표 팀 공유

### 완료 기준

- [ ] 위 1~6이 한 Play 세션에서 동작 (7·8은 가능 시)
- [ ] `MachineDefinition.prefab` 3종 연결 확인 ([04-factory-data](./04-factory-data.md))
