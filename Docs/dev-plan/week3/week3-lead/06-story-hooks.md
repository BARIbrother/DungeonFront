...
Factory **이벤트 훅** + Dev1 스토리·튜토 **전 구간** 연동. 구 7주 **5~6주**.
...
- [ ] `FactoryStoryHooks` — Dev1 `StoryEventRunner` 구독 API ([dev-contract.md](../../dev-contract.md))
- [ ] [week1 07-planning-quest-story](../../week1/week1-lead/07-planning-quest-story.md) 1일차 트리거 id 매핑
- [ ] 튜토~클리어 Factory 쪽 트리거 **전 구간** (기획 표 기준)

### 범위 밖 (Dev1)

대화 UI, 튜토 패널, 카메라 연출 — Dev1 `GameFlow/`

### 완료 기준

- [ ] 1일차 Prepare 진입 이벤트 Dev1 수신 가능
- [ ] 기획 표 트리거 id와 이벤트 일치
