...
## 세이브 JSON 스키마 (W4 병렬용 · Dev1 소유 DTO)

Dev1이 **DTO 필드만** 정의. Dev2가 `quests` 직렬화·복원 구현.  
...
W4 시작 전 `SaveData` 클래스 시그니처 **동결**. Dev2는 `quests` 외 필드 수정 금지.
