...
public static class ItemIconResolver
{
    ...
    private static readonly Dictionary<string, string> idToIconStem = new()
    {
        ...
        // 상시 의뢰·건축·의식 계열 (Assets/Art/Items)
        { "concrete", "concrete_icon" },
        { "stone", "stone_icon" },
        { "altar", "altar_icon" },
        { "mana", "mana_icon" },
        { "structure_pillar", "structure_pillar_icon" },
        { "structure_beam", "structure_beam_icon" },
        { "structure_roof", "structure_roof_icon" },
        { "iron_pillar_frame", "iron_pillar_frame_icon" },
        { "iron_beam_frame", "iron_beam_frame_icon" },
        ...
        { "ritual_scroll", "ritual_scroll_icon" },
        { "sword_ritual", "sword_ritual_icon" },
        { "war_ritual", "war_ritual_icon" },
        { "dungeon_master_essence", "dungeon_master_essence_icon" },
        { "low_monster_mana_essence", "low_monster_mana_essence_icon" },
        { "mid_monster_mana_essence", "mid_monster_mana_essence_icon" },
        { "high_monster_mana_essence", "high_monster_mana_essence_icon" },
    };
